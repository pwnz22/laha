    ...
    <div class="container">
        <div id="main_wrapper">
            ...
            <ul class="events_years">
                ...
                ?>
                <li data-url="<?php echo admin_url('admin-ajax.php'); ?>" class="events_years_item"><a href="http://laha/2016/?post_type=events">ВСЕ</a></li>
                <li class="ajax_loader"><img src="<?php echo get_template_directory_uri(); ?>/img/ajax-loader.gif" alt=""></li>
            </ul>
                <?php
